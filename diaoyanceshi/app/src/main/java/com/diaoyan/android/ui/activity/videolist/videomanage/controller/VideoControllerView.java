package com.diaoyan.android.ui.activity.videolist.videomanage.controller;
...
//                    });
    ...
    private void adjustUiDisplay() {
        ...
        if(mMediaPlayerControlListener.isFullScreen()){
            mPauseIcon = R.mipmap.ic_media_pause;
            mPlayIcon = R.mipmap.ic_media_play;
            ...
            mPauseIcon = R.mipmap.ic_media_pause_small;
            mPlayIcon = R.mipmap.ic_media_play_small;
            mPauseButton.setImageResource(mPauseIcon);
